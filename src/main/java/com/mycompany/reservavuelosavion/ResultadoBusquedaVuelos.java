 ...
 * @author Estudiante
 */
public class ResultadoBusquedaVuelos extends javax.swing.JDialog {

    /**
     * Creates new form ResultadoBusquedaVuelos
     */
    public ResultadoBusquedaVuelos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoBusquedaVuelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ResultadoBusquedaVuelos dialog = new ResultadoBusquedaVuelos(new javax.swing.JFrame(), true);
